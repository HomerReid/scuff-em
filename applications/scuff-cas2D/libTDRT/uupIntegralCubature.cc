...
{    
  ...
  double l, lp, R2, R, Arg=0.0, Factor;
  double KArray[2], K0, K1oR, K2oR2;
  double A2, LogArg=0.0, Gamma1, Gamma2, Gamma3;
  int DeSingularize;
     ...
     if ( Arg<=0.0 || Arg>50.0 )
      ...
      { if ( Arg<=1.0e-4 )
         ...
         { 
           ...
           HRBesselK(Arg, NeedDerivatives, KArray);
           K0 = KArray[0];
           K1oR = Alpha*KArray[1];
