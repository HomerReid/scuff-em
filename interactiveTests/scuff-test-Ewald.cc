...
{ 
  ...
  /***************************************************************/
  /***************************************************************/
  double RMax[3] = { 5.0, 5.0, 5.0 };
  if (LDim==1)
   RMax[0] = 1.25 * (LBV[0][0] + LBV[1][0]);
  else // LDim==2
   { RMax[0] = 1.25 * (LBV[0][0] + LBV[1][0]);
     RMax[1] = 1.25 * (LBV[0][1] + LBV[1][1]);
   };
  ...
  for(;;)
   { 
     ...
     /*--------------------------------------------------------------*/
     double R[3]; 
     R[0] = -RMax[0] + 2.0*RMax[0]*drand48();
     R[1] = -RMax[1] + 2.0*RMax[1]*drand48();
     R[2] = -RMax[2] + 2.0*RMax[2]*drand48();
