...
//////////////////////////////////////////////////
Delta=1/10;
Point(100) = {         0,   0,   T,                             0.5*lf };
Point(101) = { 1*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*1*Delta),  lf };
Point(102) = { 2*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*2*Delta),  lf };
Point(103) = { 3*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*3*Delta),  lf };
Point(104) = { 4*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*4*Delta),  lf };
Point(105) = { 5*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*5*Delta),  lf };
Point(106) = { 6*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*6*Delta),  lf };
Point(107) = { 7*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*7*Delta),  lf };
Point(108) = { 8*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*8*Delta),  lf };
Point(109) = { 9*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*9*Delta),  lf };
Point(110) = {10*Delta*R,   0,   T-H + H*Cos(2*Pi*SF*10*Delta), lf };
