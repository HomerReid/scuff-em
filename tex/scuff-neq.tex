...
%%====================================================================%
%
%The elements of the matrices in (\ref{SixBySixVMVPS}) now read
%%====================================================================%
%\begin{align}
% Q_{ab}\supt{PFLUX}(\vbhat{n}, \vb x)
% &= \left(\begin{array}{cc}
%    0 
%    & 
%    \vbhat{n}\cdot (ikZ \vb e_\alpha)^* \times \vb h_\alpha
%\\
%   -\vbhat{n}\cdot \vb h_\alpha^* \times \left(\frac{ik}{Z} \vb e_\alpha\right)
%    & 
%    0  
%    \end{array}\right)
%\end{align}
