...
individual RWG functions. For example, the flux defined
by (\ref{FSCQ}) and (\ref{FSCFlux}) may be written in
the form 

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{align*}
 \Phi = \sum_{\alpha} \Phi_{\alpha\alpha}
\end{align*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
where $\Phi_{\alpha\alpha}$, the contribution of RWG basis function


Each RWG function is associated with two triangular panels
