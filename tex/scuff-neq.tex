...
\subsection*{Computation by Taylor-Duffy method}
...
&= \ell_\alpha \ell_\beta \sum \pm 
  \underbrace{
   ...
   (\vb x-\vb Q)_j (\vb x^\prime-\vb Q)_k
...
\end{align*}
%====================================================================%
$$ f_4(x)=15-15x+6x^2 - x^3, \qquad f_5(x)=x^2(x-1)$$
%====================================================================%
\begin{align*}
 \mathcal{I}\supt{EM}(\mc P_\alpha, \mc P_\beta)
&=\iint \Big[  P_1(\vb x, \vb x^\prime) K_1(r)
              +P_2(\vb x, \vb x^\prime) K_2(r)
        \Big]\,d\vb x \, d\vb x^\prime
\\
P\supt{EM}_1 &= (\vb x-\vb Q) \times (\vb x^\prime - \vb Q^\prime) \\
K\supt{EM}_1 &= f_3(ikr)\frac{e^{ikr}}{4\pi r^3}
\\
P\supt{EM}_2 &= -(\vb x - \vb x^\prime) \cdot 
        \Big[ (\vb x-\vb Q)\times (\vb x^\prime-\vb Q^\prime) \Big]
\\
K\supt{EM}_2&= f_2(ikr)\frac{e^{ikr}}{4\pi r^5}
\end{align*}
