...
\begin{align}
 ...
 &= \frac{1}{4} \int_{\mc S} 
    ...
    \bmc F_\beta(\vb x) 
     \, d\vb x
\nn
 &\approx \frac{1}{4} \sum_{n=1}^{N\supt{C}} w_n 
...
\end{align}
%====================================================================%
where $\{w_n, \vb x_n\}$ is an $N\supt{C}$-point cubature rule 
for the surface $\mc S$ and $\vbhat{n}_n$ is the outward-pointing
surface normal to $\mc S$ at $\vb x_n.$
 
\subsection{Computation of field six-vectors}

Equation (\ref{MPSCubature}) involves a sum
each involving the field six-vectors $\bmc F$ at
