...
by (\ref{FSCQ}) and (\ref{FSCFlux}) may be written in
the form 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{align*}
...
diagonal element of the matrix in (\ref{FSCFlux}).

For visualization purposes it is convenient to think of the
quantities $\Phi_\alpha$, together with the localized supports
of the basis functions, as defining a certain \texttt{density}
of contributions to the quantity $\Phi$
Although the definition
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
 \item Basis function $\bmc B_\alpha$ is only nonvanishing on two
       triangular panels (call them $\mc P^+_\alpha$ and
       $\mc P^-_\alpha$). If we pretend that the contribution of
       this basis function to $\Phi$ is somehow equidistributed 
       then we

 \item Each triangle $\mc P$ receives three such contributions to
       the density in its interior---namely, the contributions 
        Then 

 \item $\sum_{p} A_p \Phi_p
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
