...
{
 \vb A_\alpha(\vb x) 
   = \sum_{\pm} \pm \frac{\ell_\alpha}{2A_\alpha^\pm} 
      \vb a(\mc{P}_\alpha^\pm; \vb Q_\alpha^\pm; \vb x)
 \qquad 
 \Phi_\alpha(\vb x) 
   = Z_0Z^r \sum_{\pm} \pm \frac{\ell_\alpha}{ik A_\alpha^\pm} p(\mc{P}_\alpha^\pm; \vb x)
}
%====================================================================%
...
%\numeq{eh}
% { \vb e_\alpha(\vb x) = 
%   \sum_{\pm} \frac{\ell_\alpha}{2A_\alpha}^\pm 
%              \Big[ \vb a(\mc P_\alpha^\pm; \vb Q_\alpha^\pm; \vb x) 
%                   +\frac{4}{k^2} \nabla p(\mc P_\alpha^\pm; \vb x)
%              \Big],
%  \qquad 
%  \vb h_\alpha(\vb x) &= 
%   \sum_{\pm} \frac{\ell_\alpha}{2A_\alpha}^\pm 
