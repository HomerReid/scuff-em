...
\begin{enumerate}
 \item First, \lss approximates surface currents as expansions 
       ...
       and $n$ runs over all RWG basis functions on object
       $\mathcal{O}_\beta$. (The insertion of the prefactor $-Z_0$ 
       in the expansion of $\vb N(\vb x)$ is a useful convention
       that results in a symmetric BEM matrix.)
...
additional PEC object(s) $\mathcal{O}_\beta$ and dielectric 
...
Again in the setting of Figure \ref{EmbeddedObjects}, the 
discretized version of (\ref{DielectricEquationBreakdown}) reads
%====================================================================%
\begin{align}
&\sum_{n=1}^{\texttt{NEdges}(\gamma)}  \bigg\{
   \Big\langle 
...
\noindent This procedure results in a linear system of the form
\numeq{BEMSystem}
