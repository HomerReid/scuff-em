...
\begin{align*}
\iint \vb r_i h_{\bullet} r^p
&=\iint \vb r_i \Big\{       (\vb y_a - \overline{\vb Q}_a) 
                        \cdot (\vb y_b - \overline{\vb Q}_b)
                 \Big\} r^p
\\
&= \Big\langle \vb r_i (\vb y_a \cdot \vb y_b) r^p \Big\rangle
  -\overline{\vb Q}_a \cdot \Big\langle \vb r_i \vb y_b r^p \Big\rangle
  -\overline{\vb Q}_b \cdot \Big\langle \vb r_i \vb y_a r^p \Big\rangle
  +\Big( \overline{\vb Q}_a \cdot \overline{\vb Q}_b \Big) 
   \Big\langle \vb r_i r^p \Big\rangle
\\
\iint \vb r_i h_{\nabla} r^p
&=4\iint \vb r_i r^p 
\\
&= 4 \Big\langle \vb r_i r^p \Big\rangle
\\
\iint \vb r_i h_{\times} r^p
&=\iint \vb r_i \bigg\{ \Big[ (\vb y_a \times \vb y_b)
                             \times (\vb y_b - \overline{\vb Q}_b)
                        \Big] \cdot \vb r
                 \bigg\} r^p
\\
\end{align*}
