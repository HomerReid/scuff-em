...
Then the electric dipole moment of a magnetic current distribution 
described by an RWG function populated with unit strength is 
\begin{align*}
  \vb m_\alpha 
&= l_\alpha
...
\\[5pt]
 &\to ikZ \bigg[   A_{ij} 
                  \underbrace{\Big\{ \moment{p_j}{K} + \frac{1}{Z}\moment{m_j}{N} \Big\}}
                             _{\moment{p_j}{K,N}}
                  +B_{ij} 
                  \underbrace{\Big\{ \moment{m}{K} - \frac{1}{Z}\moment{p}{N} \Big\}}
                             _{\moment{m_j}{K,N}}
          \bigg]
\\[10pt]
...
\\[5pt]
 &\to       -ik\Big[  -B_{ij} \moment{p}{K} + A_{ij} \moment{m}{K} \Big]
  +\frac{ik}{Z}\Big[   A_{ij} \moment{p}{N} + B_{ij} \moment{m}{N} \Big].
\\[5pt]
 &\to      -ik\bigg[  -B_{ij} 
                      \underbrace{\Big\{\moment{p}{K} + \frac{1}{Z}\moment{m}{N}\Big\}}
                                _{\moment{p_j}{K,N}}
                      +A_{ij} 
                      \underbrace{\Big\{\moment{m}{K} - \frac{1}{Z}\moment{m}{P}\Big\}}
                                _{\moment{m_j}{K,N}}
              \bigg].
\end{align*}
...
$$
Note that these depend on $\vb Z$.
