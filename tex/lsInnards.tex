...
\begin{enumerate}
  \item For $p=0$ and $p=2$ the integrals may be done analytically
        in closed form.
...
\paragraph{1. FIPPIs for $p=0,2$.} 

In this case all the FIPPIs are linear combinations of the 
basic integral
$$ \iint u^p v^q (u^\prime)^r (v^\prime)^s 
   = 
   \frac{1}{(2+p+q)(1+q)(2+r+s)(1+s)}.
$$
For example, we have
...
a = |\vb B^\prime|, 
\qquad
v_0^\prime = \frac{1}{a} \vb B^\prime \cdot \vb Y,
\qquad
b^2=\vb Y^2-v_0^{\prime 2},
\qquad
...
\begin{align}
 ...
 \, \Big[ r (v^\prime)\Big]^{-3} \, dv^\prime
&=
\\[5pt]
 \int_0^{u^\prime} 
 \left\{ \begin{array}{c}  1 \\ v^\prime \end{array} \right\}
 \, \Big[r (v^\prime)\Big]^{-1} \, dv^\prime
&=
\\[5pt]
 \int_0^{u^\prime} 
 \left\{ \begin{array}{c}  1 \\ v^\prime \end{array} \right\}
