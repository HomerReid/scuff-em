...
\end{subequations}
Note that my coefficients are not normalized in quite the same way
as Jackson's; the relationship is 
...
&= 
 -k^2 \sum_{\ell m} 
       \Bigg\{ \BMMExt_{\ell m}(\vb r) \cdot 
               \bigg[   \INP{ \BNNInt_{\ell m} }{\vb K}
                      + \INP{ \BMMInt_{\ell m} }{\frac{1}{Z}\vb N}
               \bigg]
\\
&\hspace{1.0in}
             + \BNNExt_{\ell m}(\vb r) \cdot 
               \bigg[   \INP{ \BMMInt_{\ell m} }{\vb K}
                      - \INP{ \BNNInt_{\ell m} }{\frac{1}{Z}\vb N}
               \bigg]
       \Bigg\}
\end{align*}
