...
\begin{align*}
  \pard{H_\bullet}{\vb R_i}
&= \iint \Big(\vb R + \vb y_a - \vb y_b\Big)_i \vb h_\bullet \psi
\\
&= \iint \Big(\vb R + \vb y_a - \vb y_b\Big)_i h_{\bullet} \psi\supt{DS}
   +\sum_{n=0}^4 \frac{(ik)^n}{4\pi} B_n 
    \iint \Big(\vb R + \vb y_a - \vb y_b\Big)_i h_{\bullet} r^{n-3}
\\[10pt]
%--------------------------------------------------------------------%
  \pard{H_\nabla}{\vb R_i}
&= \vb R_i \iint h_\nabla \psi  
...
\end{align}
%====================================================================%
Anticipating that the final answers will involve the values and
first derivatives of $\vb K$ and $\vb N$ at the origin, I write
%====================================================================%
\begin{align*}
...
wave impedance for the \textit{exterior} medium.)
...
\begin{align*}
 E_z(z) 
&= \frac{Zz \big( K_x^{(10)} + K_y^{(01)} \big)}{4ik}  
   \int_0^\infty \, \rho^3 d\rho \, \big[-3 + 3ikr - (ikr)^2\big] 
   \frac{e^{ikr}}{r^5}
\\
&\qquad
...
\end{align*}
%====================================================================%
$$ r=\sqrt{\rho^2 + z^2}, \qquad r\,dr = \rho\, d\rho $$
%====================================================================%
\begin{align*}
 E_z(z) 
&= \frac{Zz \big( K_x^{(10)} + K_y^{(01)} \big)}{4ik}  
   \int_z^\infty \, dr (r^2 - z^2) \, \big[-3 + 3ikr - (ikr)^2\big] 
   \frac{e^{ikr}}{r^4}
\\
&\qquad
 + \frac{\big( N_x^{(01)} - N_y^{(10)} \big)}{4}  
   \int_z^\infty \, dr (r^2 - z^2) \, \big[-1 + ikr ] 
   \frac{e^{ikr}}{r^2}
\end{align*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
