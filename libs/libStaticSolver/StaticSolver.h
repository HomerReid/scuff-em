...
/*
 * StaticSolver.h   -- header file for 'scuff static solver' library
 *
 *
 * homer reid   -- 5/2013
 */
...
/*--------------------------------------------------------------*/
/*--------------------------------------------------------------*/
/*- Class definition for StaticSolver                              -*/
/*--------------------------------------------------------------*/
/*--------------------------------------------------------------*/
/*--------------------------------------------------------------*/
...
class StaticSolver   
 { 
  ...
  public:  
   ...
   StaticSolver(const char *GeoFileName,
...
StaticExcitation **ReadExcitationFile(StaticSolver *SSS, char *FileName,
                                      int *pNumExcitations);
