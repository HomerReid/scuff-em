...
/*
 * StaticSolver.cc -- implementation of some methods in the StaticSolver 
...
/***********************************************************************/
/***********************************************************************/
StaticSolver::StaticSolver(const char *GeoFileName, const char *SubstrateFile, int LogLevel)
{
  Substrate=0;
  TransformLabel=0;
  ExcitationLabel=0;
...
/***********************************************************************/
/***********************************************************************/
HMatrix *StaticSolver::AllocateBEMMatrix()
{
...
/***********************************************************************/
/***********************************************************************/
HMatrix *StaticSolver::AssembleBEMMatrix(HMatrix *M)
{
  int Dim = G->TotalPanels;
...
/***********************************************************************/
/***********************************************************************/
void StaticSolver::AssembleBEMMatrixBlock(int nsa, int nsb,
                                      HMatrix *M,
...
/***********************************************************************/
/***********************************************************************/
HVector *StaticSolver::AllocateRHSVector()
{ 
  int Dim = G->TotalPanels;
...
/***********************************************************************/
/***********************************************************************/
HVector *StaticSolver::AssembleRHSVector(StaticExcitation *SE,
                                     HVector *RHS)
{
  int Dim = G->TotalPanels;
...
HVector *StaticSolver::AssembleRHSVector(double *Potentials, HVector *RHS)
...
/***********************************************************************/
/***********************************************************************/
HMatrix *StaticSolver::GetCartesianMoments(HVector *Sigma, HMatrix *Moments)
{
...
/***************************************************************/
HVector *StaticSolver::GetSphericalMoments(HVector *Sigma, int WhichSurface, 
...
/***************************************************************/
HVector *StaticSolver::GetSphericalMoments(HVector *Sigma, 
                                       int lMax, 
                                       HVector *Moments)
{
  int NAlpha = (lMax+1)*(lMax+1);
...
/***********************************************************************/
/***********************************************************************/
HMatrix *StaticSolver::GetFields(StaticExcitation *SE, HVector *Sigma, 
...
HMatrix *StaticSolver::GetFields(HVector *Sigma, HMatrix *X, HMatrix *PhiE)
...
/***************************************************************/
/***************************************************************/
void StaticSolver::AddSubstrateContributionToPanelPhiE(int ns, int np, double *XD, double PhiE[4])
{
...
/***************************************************************/
/***************************************************************/
void StaticSolver::AddSubstrateContributionsToBEMMatrixBlock(int nsa, int nsb, HMatrix *M, int RowOffset, int ColOffset)
{
