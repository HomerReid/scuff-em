...
/***************************************************************/
void WriteFVMesh(StaticSolver *SSS, RWGSurface *S, HVector *Sigma,
...
/* visualization.                                              */
/***************************************************************/
void StaticSolver::VisualizeFields(HVector *Sigma,
                               char *FVMeshFile,
                               char *OutFileBase,
                               StaticExcitation *SE,
                               char *TransFile)
...
/***************************************************************/
/***************************************************************/
HMatrix *StaticSolver::GetCapacitanceMatrix(HMatrix *M,
                                        HVector *Sigma,
                                        HMatrix *CMatrix)
{
...
/***********************************************************************/
/***********************************************************************/
void StaticSolver::PlotChargeDensity(HVector *Sigma, char *BaseFileName)
{
  /*--------------------------------------------------------------*/
  /*--------------------------------------------------------------*/
  /*--------------------------------------------------------------*/
