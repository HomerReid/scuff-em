/* 
 * StaticPPITaylor.cc: a specialized version of taylor's method for 
 *                     computing static contributions to panel-panel
 *                     integrals
 *
 * homer reid          11/2009
 */
...
/***************************************************************/
/***************************************************************/
void ComputeStaticPPIData_Taylor(double *V1, double *V2, double *V3, 
