...
{ 
  ...
  GetPPIArgs->VerticesA              = VerticesA;
  GetPPIArgs->VerticesB              = VerticesB;
  GetPPIArgs->k                      = k;
  ...
  /*--------------------------------------------------------------*/
  GetPPIArgs->Pa = PanelsA[Ea->iPPanel];   GetPPIArgs->iQa = Ea->PIndex;
  GetPPIArgs->Pb = PanelsB[Eb->iPPanel];   GetPPIArgs->iQb = Eb->PIndex;
  GetPanelPanelInteractions(GetPPIArgs, HPP, GradHPP, dHdTPP);

  if ( Eb->iMPanel != -1 )
   { 
     GetPPIArgs->Pa = PanelsA[Ea->iPPanel];   GetPPIArgs->iQa = Ea->PIndex;
     GetPPIArgs->Pb = PanelsB[Eb->iMPanel];   GetPPIArgs->iQb = Eb->MIndex;
     GetPanelPanelInteractions(GetPPIArgs, HPM, GradHPM, dHdTPM);
   };

  if ( Ea->iMPanel != -1 )
   { 
     GetPPIArgs->Pa = PanelsA[Ea->iMPanel];   GetPPIArgs->iQa = Ea->MIndex;
     GetPPIArgs->Pb = PanelsB[Eb->iPPanel];   GetPPIArgs->iQb = Eb->PIndex;
