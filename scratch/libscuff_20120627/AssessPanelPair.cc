...
/***************************************************************/
/* this routine gathers some information on a pair of panels.  */
/*                                                             */
...
/***************************************************************/
int AssessPanelPair(RWGPanel *Pa, double *VerticesA,
                    RWGPanel *Pb, double *VerticesB,
                    double *rRel, double **Va, double **Vb)
{
  Va[0] = VerticesA + 3*Pa->VI[0];
  Va[1] = VerticesA + 3*Pa->VI[1];
  Va[2] = VerticesA + 3*Pa->VI[2];

  Vb[0] = VerticesB + 3*Pb->VI[0];
  Vb[1] = VerticesB + 3*Pb->VI[1];
  Vb[2] = VerticesB + 3*Pb->VI[2];
...
{ 
  double *Va[3], *Vb[3];
  return AssessPanelPair(Pa, VerticesA, Pb, VerticesB, rRel, Va, Vb);
} 
