...
= (-i\omega p_0)(ik)
  \left\{\begin{array}{r}
  Z\mb G_{\ell j}(\vb x, \vb x\subt{S}) 
   \\[8pt]
   -\mb C_{\ell j}(\vb x, \vb x\subt{S})
  \end{array}\right\}
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
= \frac{E_i\sups{scat}}{(ikZ)(-i\omega p_0)}
= -(ik) \vb v(\vb x\subt{D}, \vbhat n_{i})^T \vb W
        \vb v(\vb x\subt{S}, \vbhat n_{j}).
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\numeq{GijMVMVP}
{
 \mc G_{ij}\supt{M}(\vb x\subt{D}, \vb x\subt{S})
= \frac{H_i\sups{scat}}{(ikZ^{-1})(-i\omega m_0)}
= +ik \wt{\vb v}(\vb x\subt{D}, \vbhat n_{i})^T \vb W
      \wt{\vb v}(\vb x\subt{S}, \vbhat n_{j}).
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
