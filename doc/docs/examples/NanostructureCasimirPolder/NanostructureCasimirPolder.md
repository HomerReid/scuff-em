...
Hung et al. for a 1D lattice, then extend to the
case of a 2D square lattice.
...
## [[gmsh]] geometry file for nanobeam unit cell
...
memory and computation time requirements, and it may
be found, for example, by running 
...
## [[scuff-em]] geometry file for SiO2 nanobeam

A [[scuff-em]] [geometry file][scuffEMGeometries] 
describing an extended nanobeam consisting of infinitely
many repetitions of the above unit cell is 
``NanoBeam
$two infinite-length dielectric beams is
